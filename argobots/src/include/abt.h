 ...
 */
#define ABT_VERSION "1.0a1"
#define ABT_NUMVERSION 10000001
...
int ABT_my_xstream_run_unit(ABT_unit unit, ABT_pool pool, ABT_sched sched) ABT_API_PUBLIC;
int ABT_xstream_check(ABT_pool pool, int *run_cnt, ABT_sched sched) ABT_API_PUBLIC; 
int ABT_my_migrate(ABT_pool *pools, ABT_sched sched, int *run_cnt) ABT_API_PUBLIC;
int ABT_my_pools_of_sched(ABT_sched sched, ABT_pool *pools) ABT_API_PUBLIC;
int ABT_my_pools_of_sched_0(ABT_sched sched, ABT_pool *pools) ABT_API_PUBLIC;
